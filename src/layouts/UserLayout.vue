                ...
                <div class="dropdown dropdown-end">
                    <div tabindex="0" role="button" class="btn btn-ghost btn-circle">
                        <div class="indicator">
                            ...
                            <span class="badge badge-sm indicator-item">{{ cardStore.summaryQuantity }} </span>
                        </div>
                    </div>
                    <div tabindex="0" class="card card-compact dropdown-content bg-base-100 z-[1] mt-3 w-52 shadow">
                        <div class="card-body">
                            <span class="text-lg font-bold">{{ cardStore.summaryQuantity }} Items</span>
                            <span class="text-info">Subtotal: {{ cardStore.summaryPrice }} BATH</span>
                            <div class="card-actions">
                                <RouterLink :to="{ name: 'card' }" class="btn btn-primary btn-block">View cart
                                </RouterLink>
                            </div>
                        </div>
                    </div>
